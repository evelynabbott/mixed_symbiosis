...
input="resample20k_D.RData"
lnames = load(file = input);
datExpr=t(vsd.re)
datTraits=coldata.re
...
#plot the gene tree
pdf(file="geneTree_D.pdf", width=40, height=20)
...
#plot them
MEDissThres=0.35
pdf(file="Clustering_module_eigengenes_D.pdf")
...
sizeGrWindow(12, 9)
pdf(file = "Plots_geneDendro-3_D.pdf", wi = 9, he = 6)
...
outName="D_networkdata_signed_2.RData"
save(sampleNames,  MEs, moduleLabels, moduleColors, geneTree, file = outName)
